...
class UpdateUserMissingCaseScreen extends StatelessWidget {
  ...
  UpdateUserMissingCaseScreen({Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MainCubit, MainState>(
      ...
      builder: (context, state) {
            ...
            whatsNumberController.text = whatsNumberController.text.isEmpty ? model!.phone.toString() : whatsNumberController.text;
                ...
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child:  Padding(
                        ...
                        child: Column(
                          children: [
                            MainCubit.get(context).personImage == null ?  Image(image: NetworkImage(model!.photo!),height: 180,) :
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: defaultButton(
                                function: (){
                                  MainCubit.get(context).updateMissingCase(
